...
const Integrations = () => {
  ...
  return (
    <section
      className="w-full max-w-[1280px] h-auto md:h-[797px] mx-auto relative flex flex-col items-center overflow-hidden"
      style={{
        borderRadius: "30px",
    ...
    >
      ...
      <div className="relative w-full max-w-[1100px] h-[350px] mt-[40px]">
        {/* Center Logo */}
        <div className="absolute top-[140px] md:top-[125px] left-1/2 -translate-x-1/2 w-[60px] md:w-[100px] h-[60px] md:h-[100px] z-30 flex items-center justify-center bg-[#b53be2b3] backdrop-blur-xl rounded-[12px] md:rounded-[20px] shadow-[inset_0_0_20px_rgba(248,248,248,0.4)]">
           <Image src={'/logo.png'} width={31} height={31} alt="logo" priority className="w-[20px] md:w-[31px] h-[20px] md:h-[31px]"  />
        </div>
        ...
        <div className="absolute bottom-[90px] md:bottom-[20px] left-[8px] md:left-[180px] z-20">
          <TechIcon icon={<DiReact />} />
          <div className="absolute -z-10 left-[40px] bottom-[2px] md:bottom-[55px] md:-left-[40px] w-[120px] h-[80px] md:w-[380px] md:h-[100px] pointer-events-none">
        ...
        <div className="absolute top-[80px] right-[4px] md:top-[44px] md:right-[108px] z-20">
          ...
          <div className="absolute right-[2px] -top-[0px] md:top-[30px]  md:right-[60px] -z-10 w-[160px] md:w-[250px] h-[100px] md:h-[120px] pointer-events-none">
            <Image src="/home/integration/vector1.png" fill alt="line" className="object-contain" />
          </div>
        </div>
        ...
        <div className="absolute right-[8px] bottom-[90px] md:bottom-[10px] md:right-[170px] z-20">
          <TechIcon icon={<SiTailwindcss />} />
          <div className="absolute right-[40px] bottom-[2px] md:bottom-[55px] md:-right-[40px] w-[120px] h-[80px] md:w-[380px] -z-10 md:h-[110px] pointer-events-none">
...
const TechIcon = ({ icon }: { icon: React.ReactNode }) => (
  <div
    className="relative flex items-center justify-center text-white w-[40px] h-[40px] md:w-[60px] md:h-[60px] rounded-[10px] bg-[#B53BE2] shadow-[inset_0px_-4px_19px_0px_#EAB1FF,0px_0px_20px_rgba(181,59,226,0.4)]"
  >
    <div className="flex items-center justify-center w-[20px] h-[20px] md:w-[25px] md:h-[24px]">
