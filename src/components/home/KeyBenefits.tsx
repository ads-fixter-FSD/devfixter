  ...
  return (
    <section className="relative w-full bg-black py-24 flex justify-center overflow-hidden">
      ...
      <div className="custom-container flex flex-col items-center px-4 relative z-10 w-full">
        ...
        custom={0.5}
        viewport={{once:false}}
        className="max-w-[846px] mx-auto text-center flex flex-col items-center gap-4 mb-20">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 relative z-0">
            ...
            whileInView={'visible'}
            custom={0.5}
            viewport={{once:false}}  className="flex flex-col items-center text-center px-8 py-10 sm:py-14 h-auto min-h-[200px] sm:min-h-[246px] justify-center relative border-b border-transparent bg-transparent sm:bg-black/30">
            ...
            whileInView={'visible'}
            custom={0.6}
            viewport={{once:false}}  className="flex flex-col items-center text-center px-8 py-10 sm:py-14 h-auto min-h-[200px] sm:min-h-[246px] justify-center relative sm:border-r border-transparent bg-transparent sm:bg-black/30">
